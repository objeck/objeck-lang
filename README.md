...
More Rosetta Code [examples](https://github.com/objeck/objeck-lang/tree/master/programs/tests/rc) and [LSP](https://github.com/objeck/objeck-lsp) server support.
