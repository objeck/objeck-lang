...
More Rosetta Code [examples](https://github.com/objeck/objeck-lang/tree/master/programs/tests/rc) and [IDE](https://github.com/objeck/objeck-lsp) server support.
