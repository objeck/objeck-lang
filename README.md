...
**Latest**: Enhanced [LSP](https://github.com/objeck/objeck-lang-server) support for your favorite IDE (such as VS Code, Sublime, VIM, etc.). Added method and function renaming to v1.0.2. Adding code reformatting for v1.0.3.
