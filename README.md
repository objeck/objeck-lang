...
__News (1/15/20223):__ Happy New Year, everyone! Thank your all for your feedback on new project ideas. For 2023, I will take Objeck in a different direction and focus on ML via the [TensorFlow](https://www.tensorflow.org/) framework. It will be a wild ride, and I am looking for folks interested in data science and ML to assist along the way.
