...
__News (1/15/20223):__ Happy New Year, everyone! Thank you all for submitting new project ideas. For 2023, I will take Objeck in a different direction and focus on ML utilizing the [TensorFlow](https://www.tensorflow.org/) framework. It will be a fun ride, I am looking for people interested in data science, ML and AI to assist along the way.
