...
**Latest**: Enhancing [LSP](https://github.com/objeck/objeck-lang-server) support by adding method/function renaming and code reformatting for your favorite IDE (VS Code, Sublime, Emacs, VIM, etc.).
