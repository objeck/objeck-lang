...
(Get-Content ..\..\doc\man\obc.in) | ForEach-Object { $_ -replace "@VERSION@", $version_posix_long } | Set-Content ..\..\doc\man\obc.1
(Get-Content ..\..\doc\man\obr.in) | ForEach-Object { $_ -replace "@VERSION@", $version_posix_long } | Set-Content ..\..\doc\man\obr.1
(Get-Content ..\..\doc\man\obd.in) | ForEach-Object { $_ -replace "@VERSION@", $version_posix_long } | Set-Content ..\..\doc\man\obd.1
(Get-Content ..\..\doc\man\obu.in) | ForEach-Object { $_ -replace "@VERSION@", $version_posix_long } | Set-Content ..\..\doc\man\obu.1
