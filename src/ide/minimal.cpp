...
wxDEFAULT_FRAME_STYLE | wxNO_FULL_REPAINT_ON_RESIZE)
{
...
#if 1
  wxStyledTextCtrl* text = new wxStyledTextCtrl(m_splitter, wxID_ANY);
  ...
  */
  ...
  m_left = text;
  // m_left = new wxRichTextCtrl(m_splitter, -1, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxRE_MULTILINE, wxDefaultValidator, wxTextCtrlNameStr);
