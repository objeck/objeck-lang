/* PrismJS 1.15.0
https://prismjs.com/download.html#themes=prism&languages=clike&plugins=line-highlight+line-numbers */
...
Prism.languages.clike = {
	...
	'class-name': {
		pattern: /((?:\b(?:class|interface|from|implements|New)\s+)|(?:catch\s+\())[\w.\\]+/i,
		lookbehind: true,
		inside: {
			punctuation: /[.\\]/
		}
	},
	'keyword': /\b(?:if|else|while|do|for|return|method|function|New|use|alias|leaving|Nil|String|break|Int|Float|Byte|Char)\b/,
