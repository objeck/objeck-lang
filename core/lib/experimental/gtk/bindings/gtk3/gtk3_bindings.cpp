...
extern "C" {
	...
	void gtk3_gdk_atom_intern_static_string(VMContext& context) {
		...
		const auto status = gdk_atom_intern_static_strin);
	...
	void gtk3_gdk_events_get_angle(VMContext& context) {
		...
		const gdouble p3 = (gdouble)APITools_GetFloatValue(context, 3);

		const auto status = gdk_events_get_angle(p1, p2, p3);
	...
	void gtk3_gdk_events_get_center(VMContext& context) {
		...
		const gdouble p3 = (gdouble)APITools_GetFloatValue(context, 3);
		const gdouble p4 = (gdouble)APITools_GetFloatValue(context, 4);

		const auto status = gdk_events_get_center(p1, p2, p3, p4);
	...
	void gtk3_gdk_events_get_distance(VMContext& context) {
		...
		const auto status = gdk_events_get_distance(p1, p2, p3);
	...
	void gtk3_gdk_event_get_axis(VMContext& context) {
		...
		const auto status = gdk_event_get_axis(p1, p2, p3);
	...
	void gtk3_gdk_event_get_button(VMContext& context) {
		...
		const auto status = gdk_event_get_button(p1, p2);
	...
	void gtk3_gdk_event_get_click_count(VMContext& context) {
		...
		const auto status = gdk_event_get_click_count(p1, p2);
	...
	void gtk3_gdk_event_get_coords(VMContext& context) {
		...
		const auto status = gdk_event_get_coords(p1, p2, p3);
	...
	void gtk3_gdk_event_get_keycode(VMContext& context) {
		...
		const auto status = gdk_event_get_keycode(p1, p2);
	...
	void gtk3_gdk_event_get_keyval(VMContext& context) {
		...
		const auto status = gdk_event_get_keyval(p1, p2);
	...
	void gtk3_gdk_event_get_root_coords(VMContext& context) {
		...
		const auto status = gdk_event_get_root_coords(p1, p2, p3);
	...
	void gtk3_gdk_event_get_scroll_deltas(VMContext& context) {
		...
		const auto status = gdk_event_get_scroll_deltas(p1, p2, p3);
	...
	void gtk3_gdk_event_get_scroll_direction(VMContext& context) {
		const GdkEvent* p1 = (const GdkEvent*)APITools_GetIntValue(context, 1);
		const GdkScrollDirection p2 = (GdkScrollDirection)APITools_GetIntValue(context, 2);

		const auto status = gdk_event_get_scroll_direction(p1, p2);
	...
	void gtk3_gdk_event_get_state(VMContext& context) {
		const GdkEvent* p1 = (const GdkEvent*)APITools_GetIntValue(context, 1);
		const GdkModifierType p2 = (GdkModifierType)APITools_GetIntValue(context, 2);

		const auto status = gdk_event_get_state(p1, p2);
