...
./obc -src lib_src/net_misc.obs -tar lib -opt s3 -dest ../lib/net_misc.obl
...
./obc -src lib_src/csv.obs -tar -lib gen_collect.obl -opt s3 -dest ../lib/csv.obl
./obc -src lib_src/query.obs -tar lib -lib xml.obl,regex.obl,gen_collect.obl -opt s3 -dest ../lib/query.obl
