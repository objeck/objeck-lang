...
if [%1] NEQ [deploy] goto end
	...
	signtool sign /f "%USERPROFILE%\Dropbox\Personal\signing keys\2022\code\randy_hollines.p12" /p %2 /d "Objeck Toolchain" /t http://timestamp.sectigo.com /fd SHA256 Release64\setup.msi
