...
const char* ObjeckWordlist1 = 
  ...
  "interface label method native "
  "or other private public "
...
const LanguageInfo g_LanguagePrefs [] = {
     ...
     "*.obs;*.obw",
     wxSTC_LEX_OBJECK,
     {{ mySTC_TYPE_DEFAULT, NULL }, // SCE_OBJK_DEFAULT
     { mySTC_TYPE_IDENTIFIER, ObjeckWordlist1 }, // SCE_OBJK_IDENTIFIER
     { mySTC_TYPE_NUMBER, NULL }, // SCE_OBJK_NUMBER
     { mySTC_TYPE_OPERATOR, NULL }, // SCE_OBJK_OPERATOR
     { mySTC_TYPE_WORD2, ObjeckWordlist2 }, // SCE_OBJK_WORD2
     { mySTC_TYPE_COMMENT_LINE, NULL }, // SCE_OBJK_COMMENTLINE
     { mySTC_TYPE_COMMENT_DOC, NULL }, // SCE_OBJK_COMMENTDOC
     { mySTC_TYPE_CHARACTER, NULL },  // SCE_OBJK_CHARACTER
     { mySTC_TYPE_STRING, NULL },  // SCE_OBJK_STRING
