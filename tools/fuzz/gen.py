...
class Generator:
    def __init__(self, choices, features=None, seed=None):
        self.c = choices
        self.seed = seed
    ...
    def program(self):
        ...
        self.basic_lambdas = self.has("F5") and self.c.chance(15)
        out = []
        out.append("#~")
...
def generate(seed=None, choices=None, features=None):
...
if __name__ == "__main__":
    ...
    print(generate(seed=args.seed, features=feats).text)
