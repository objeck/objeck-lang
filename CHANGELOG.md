...
Release-process fixes found by running the v2026.9.0 release, then a survey of
every binary and library for the bugs a compiler, VM and debugger platform
cannot carry. These landed after the v2026.9.0 tag, so they are **not** in that
release's binaries.
