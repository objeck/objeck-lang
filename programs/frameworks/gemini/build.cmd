...
obc -src %OBJECK_LIB_SRC%\gemini.obs -lib misc,json,net,cipher -tar lib -dest %OBJECK_LIB_DST%\gemini.obl

del /q *.obe

if [%1] == [] goto end
	obc -src %1 -lib csv,misc,ml,net,json,cipher,gemini -dest %1
	obr %1 %2 %3 %4 %5
:end