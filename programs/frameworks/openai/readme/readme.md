Introducing new and enhanced integration features: Ollama support for Llama 3 and Mistral, OpenAI support for vector stores and Assistants v2 APIs, support for Perplexity APIs.
