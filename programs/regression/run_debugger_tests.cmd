...
powershell.exe -ExecutionPolicy Bypass -File "%REGRESSION_DIR%\run_debugger_tests_win.ps1" -Debugger "%ABS_DEBUGGER%" -TestBin "%REGRESSION_DIR%\debugger_test.obe" -CollBin "%REGRESSION_DIR%\debugger_coll_test.obe" -EvalBin "%REGRESSION_DIR%\debugger_eval_test.obe" -SrcDir "%REGRESSION_DIR%" -ResultsDir "%REGRESSION_DIR%\%RESULTS_DIR%"
