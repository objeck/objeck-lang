...
\begin{itemize}
	...
	\item Functional support (higer-order functions) 
...
\begin{itemize}
    ...
    \item \texttt{Power} - returns the exponential power value
    	\begin{itemize}
	\item function : Power(), Float
	\end{itemize}
    \item \texttt{SquareRoot} - returns the square root
    	\begin{itemize}
	\item function : SquareRoot(), Float
	\end{itemize}
    \item \texttt{Print} - prints the current value
    	\begin{itemize}
	\item method : native : Print(), Nil
...
-------------------------------------
Objeck v1.1.0 - Interactive Debugger
-------------------------------------
