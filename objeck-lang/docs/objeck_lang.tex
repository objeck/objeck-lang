...
The Objeck language toolset contains a simple interactive debugger that allows programmers to inspect values within a program.  The debugger will also calculate simple arithmetic expressions that contain either variable values or constants. The debugger allows programmers to set breakpoints within methods based upon source line numbers.  The following commands are currently supported:
