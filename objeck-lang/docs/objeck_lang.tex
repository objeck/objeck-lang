...
\begin{itemize}
	...
	\end{itemize}
    \item \texttt{GetHeaders} - Returns a \texttt{BinaryTree} of headers information.  HTTP header information is populated after a HTTP GET request.
    	\begin{itemize}
	\item method : GetHeaders(), BinaryTree
	\end{itemize}
\end{itemize}
