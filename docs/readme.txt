v2026.9.1 (September 8, 2026)
===
Every string hash was wrong and is now right, JIT arithmetic matches the interpreter, the debugger sees threads and tells the truth about its commands, Game.OpenGL gains a sky, rotations, normal maps and emissive materials, and the release pipeline reports what it actually did.
