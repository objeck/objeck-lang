v2026.9.1 (September 9, 2026)
===
Every string hash was wrong and is now right, JIT arithmetic matches the interpreter and the JIT is 2-8x faster on common loops, the debugger sees threads and tells the truth about its commands, Game.OpenGL gains a sky, rotations, normal maps and emissive materials, and the release pipeline reports what it actually did.
