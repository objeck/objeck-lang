...
$language_data = array(
    ...
    'QUOTEMARKS' => array('"'),
    'ESCAPE_CHAR' => '\\',
    'KEYWORDS' => array(1 => array('virtual', 'in', 'leaving', 'if', 'else', 'do', 'while', 'use', 'bundle', 'native', 'break', 'continue', 'static', 'public', 'private', 'class', 'interface', 'alias', 'function', 'method', 'select', 'other', 'consts', 'enum', 'for', 'each', 'reverse', 'label', 'return', 'from', 'implements', 'critical', 'and', 'or', 'xor', 'not'), 2 => array('Byte', 'Int', 'Nil', 'Float', 'Char', 'Bool', 'String', 'Parent', 'As', 'TypeOf', 'New', 'Try', 'Otherwise'), 3 => array('true', 'false')
        ),
    'SYMBOLS' => array(
        1 => array(
            '(', ')', '{', '}', '[', ']', '+', '-', '*', '/', '%', '=', '<', '>', '&', '|', ':', ';', ',', '+=', '-=', '*=', '/=', 
