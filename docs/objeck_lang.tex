...
\texttt{[r]un} &  runs a program, which stops at breakpoints \\ \hline
\texttt{[p]rint} &  prints the values of an expression \\ \hline
\texttt{[l]ist} &  list the lines of a source file \\ \hline
\texttt{[i]nfo} &  display the variables of a class or method \\ \hline
\texttt{load} &  loads a new executable \\ \hline
