...
\begin{center}
  \begin{tabular}{ | c | c | c | c | c | }
    ...
    each & else & enforces & enum & false \\ \hline
    Float & for & from & function & if \\ \hline
    Int & interface & label & method & mixin \\ \hline
    native & New & or & other & Parent \\ \hline
    private & public & return & select & static \\ \hline
    true & use & virtual & while & xor \\ \hline
  \end{tabular}
\end{center}
