...
\begin{abstract}
  ...
  please refer to the
  \htmladdnormallink{main}{http://rosettacode.org/wiki/Category:Objeck} and
  \htmladdnormallink{design}{http://sourceforge.net/apps/mediawiki/objeck-lang/index.php?title=Objeck_Programming_Language} 
  webpages.
\end{abstract}
