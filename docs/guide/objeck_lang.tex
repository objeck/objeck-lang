...
\item \texttt{ReplaceAll} - find and replace all string instances
  ...
  \item method : public : native : ReplaceAll(find : String, replace :
    String) \textasciitilde String
  \end{itemize}
\item \texttt{Insert} - inserts a string
  \begin{itemize}
  \item method : public : native : Insert(index : Int, string :
    String) \textasciitilde Bool
  \end{itemize}
\item \texttt{Delete} - deletes a portion of the string
  \begin{itemize}
  \item method : public : native : Delete(index : Int) \textasciitilde Bool
  \item method : public : native : Delete(start : Int, end : Int) \textasciitilde Bool      
  \end{itemize}
