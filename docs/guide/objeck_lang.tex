...
\begin{abstract}
  ...
  functionality that is included in release \textit{1.5.0}.  For
...
\item \texttt{GetClass} - returns metadata about a class
  \begin{itemize}
  \item method : public : GetClass, Class
  \end{itemize}
...
\item \texttt{ToUpper} - coverts a character to a uppercase
  character
  \begin{itemize}
  \item method : public : native : ToUpper(), Char
  \end{itemize}
\item \texttt{ToLower} - coverts a character to a lowercase
  character
  \begin{itemize}
  \item method : public : native : ToLower(), Char
  \end{itemize}
...
\item \texttt{Min} - returns the smallest of the two numbers; returns
  ...
  \begin{itemize}
  \item method : native : Min(r : Char), Char
  \end{itemize}
\item \texttt{Max} - returns the largest of the two numbers; returns
  the same number if they are equal
  \begin{itemize}
  \item method : native : Max(r : Char), Char
  \end{itemize}
\item \texttt{Print} - prints the current value
  \begin{itemize}
  \item method : native : Print(), Nil
...
\item \texttt{IsLoaded} - returns true if this class has been loaded
  \begin{itemize}
  \item method : public : IsLoaded(), Bool
  \end{itemize}
\item \texttt{IsLoaded} - returns true if this class has been loaded,
  false otherwise
  \begin{itemize}
...
\item \texttt{GetMethods} - returns an array of methods
  \begin{itemize}
  \item method : public : GetMethods(), GetMethods[]
  \end{itemize}
\item \texttt{GetMethodNumber} - returns the number of methods in the class
  \begin{itemize}
  \item method : public : GetMethodNumber(), Int
  \end{itemize}
\end{itemize}
...
\item \texttt{GetParameters} - returns the datatypes of the parameters
  \begin{itemize}
  \item method : public : GetParameters(), DataType[]
  \end{itemize}

\item \texttt{GetReturn} - returns the datatype of the return
  \begin{itemize}
  \item method : public : GetReturn(), DataType
  \end{itemize}
\end{itemize}
...
\item \texttt{WriteBuffer} - writes n number of bytes to a file.
  \begin{itemize}
  \item method : public : WriteBuffer(buffer : Byte[]), Int
...
\item \texttt{Add} - deflates a datatype
  \begin{itemize}
  \item method : public : Add(b : Bool), Nil
  \end{itemize}
\begin{itemize}
  \item method : public : Add(i : Int), Nil
  \end{itemize}
\begin{itemize}
  \item method : public : Add(f : Float), Nil
  \end{itemize}
\begin{itemize}
  \item method : public : Add(o : Base), Nil
  \end{itemize}
\begin{itemize}
  \item method : public : Add(b : Bool[]), Nil
  \end{itemize}
\begin{itemize}
  ...
  \end{itemize}
\begin{itemize}
  \item method : public : Add(b : Byte[]), Nil
  \end{itemize}
\begin{itemize}
  \item method : public : Add(c : Charl[]), Nil
  \end{itemize}
\begin{itemize}
  \item method : public : Add(i : Int[]), Nil
  \end{itemize}
