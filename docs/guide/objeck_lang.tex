...
\begin{abstract}
  ...
  functionality that is included as part of release \textit{2.1.4}.  For
...
\item \texttt{New} - Compilers the regular expression
  ...
  \end{itemize}
\item \texttt{Apply} - Applies the initial regular expression
  \begin{itemize}
  \item method : public : Apply(string : String) \textasciitilde String
  \end{itemize}
\item \texttt{Next} - Applies the regular expression to the remainder
  of the string
  \begin{itemize}
  \item method : public : Next() \textasciitilde String
  \end{itemize}
\end{itemize}
