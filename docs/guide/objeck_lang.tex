...
\begin{itemize}
\item \begin{verbatim}int DLLTools_GetArraySize(long* array);\end{verbatim}
\item \begin{verbatim}int DLLTools_GetFunctionValue(long* array, int index, FunctionId id);\end{verbatim}
\item \begin{verbatim}void DLLTools_SetFunctionValue(long* array, int index, FunctionId id, int value);\end{verbatim}
\item \begin{verbatim}long DLLTools_GetIntValue(long* array, int index);\end{verbatim}
\item \begin{verbatim}void DLLTools_SetIntValue(long* array, int index, long value);\end{verbatim}
\item \begin{verbatim}double DLLTools_GetFloatValue(long* array, int index);\end{verbatim}
\end{itemize}
