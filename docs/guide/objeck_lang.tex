...
The XMLParser class allows programmers to parse and search XML documents using a simplified DOM.  This class in the `XML' bundle:
\begin{itemize}
    \item \texttt{New}
    	\begin{itemize}
	\item New(buffer : Byte[])
	\end{itemize}
    \item \texttt{New}
    	\begin{itemize}
	\item New(file : String)
	\end{itemize}
  ...
  \item \texttt{Parse} - Parses an XML stream into a DOM structure.  Returns true if successful; false otherwise.
	...
	\item \texttt{FindElements} - returns all elements that match the given query string.
    	\begin{itemize}
	\item method : public : Parse(), Bool
	\end{itemize}
	...
	\item \texttt{GetError} - Returns the last parsing error; if one occured.
    	\begin{itemize}
	\item method : public : Parse(), Bool
	\end{itemize}	
\end{itemize}
...
\begin{itemize}
	\item \texttt{New}
    	\begin{itemize}
	\item New(name : String, type : XMLElementType, attribs : StringHash, content : String)
	\end{itemize}
	...
	\item \texttt{GetType} - Returns the element type.
    	\begin{itemize}
	\item method : public : GetType(), String
	\end{itemize}
...
-------------------------------------
Objeck v1.1.3 - Interactive Debugger
-------------------------------------
