...
\begin{abstract}
  ...
  functionality that's part of v3.1.6.  For
...
data structures like vectors, lists and maps.  This section also provides 
documentation on libraries that provided XML, JSON, encryption and regular expression 
support. As new classes are added they'll be documented in this section.
...
Supports system console I/O and general I/O interfaces.
...
Provides time and date operations.  These classes are located in the `System.Time'
bundle.
...
hashes, maps, etc.  These classes are located in the `Collection'
bundle.
...
\subsection{HTTP}
These classes provide support for the HTTP and TAPAS web protocols.
...
\subsection{RegEx}
\subsubsection{RegEx}
The RegEx class provides support for regular expressions.  This class in the `RegEx' bundle:
