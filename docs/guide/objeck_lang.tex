...
\begin{center}
  \begin{tabular}{| l | l |}
    ...
    \texttt{Char} &  Posix 1--byte character, Windows 2--byte character, External UTF-8 1--byte stream \\ \hline
...
\item \texttt{ToCharArray} - converts a string to a \texttt{Char[]}
  ...
  \item method : public : native : ToCharArray() \textasciitilde
    Char[]
  \end{itemize}
\item \texttt{ToByteArray} - converts a string to a \texttt{Bytte[]}
  \begin{itemize}
